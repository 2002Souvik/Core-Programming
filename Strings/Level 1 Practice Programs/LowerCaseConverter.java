...
public class LowerCaseConverter {
    ...
    public static void main(String[] args) {
        ...
        String builtInLowerCaseString = userInput.toLowerCase();

        System.out.println("Converted String: " + convertedString);
        System.out.println("Built-in Lowercase String: " + builtInLowerCaseString);

        boolean areEqual = compareStrings(convertedString, builtInLowerCaseString);
